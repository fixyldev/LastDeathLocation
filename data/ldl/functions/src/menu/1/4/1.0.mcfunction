...
tellraw @s ["  ", {"translate": "ldl.menu.1.4.1.version", "fallback": "Version:  ", "color": "gold"}, {"text": "2.0.0", "color": "yellow"}]
tellraw @s ["  ", {"translate": "ldl.menu.1.4.1.date", "fallback": "Date:      ", "color": "gold"}, {"text": "2024-02-11", "color": "yellow"}]
